...
- 🟢 `⌘/Ctrl+Z` → **undo**, `⌘/Ctrl+Shift+Z` → **redo** — app-wide deck undo/redo (`useDeckHistory`, see §11.7). Suppressed while typing in a field so the browser's native text undo still works.
