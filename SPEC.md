...
- Marquee selection (shift-click multi-select ✅, align over a selection — horizontal + vertical ✅, and distribute ✅ shipped; marquee drag-rectangle still ⚪).
...
| Presenter | 🟡 |
| Canvas selection / direct manipulation | 🟢 core + multi-select/move/align (H+V)/distribute (⚪ rotate/marquee) |
