...
describe('DataPanel', () => {
  it('routes chart/roadmap/agenda/list/kpi/split slides to their data editors', () => {
  ...
  it('shows a hint for slides without editable data, and when nothing is selected', () => {
    ...
    expect(screen.getByText(/chart, roadmap, agenda, list, KPI, and split slides/i)).toBeInTheDocument();
